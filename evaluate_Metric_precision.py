...
def EVAL_precision(pth_path, excel_path):
    ...
    if eval_model == 1:
        ...
        classes_number = 2
        OA_labels = torch.load(os.path.join(pth_path, "label0.pth")) 
        model_predict = torch.load(os.path.join(pth_path, "predict0.pth"))
