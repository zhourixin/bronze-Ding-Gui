...
#         target_list_sig.append(int(targets[i])+8)
#         shape_targets_list.append(int(shape_labels[i])+28)
...
def get_order_family_target(targets, device, shape_labels, ware_cat_label,level1_targets):
    ...
    for i in range(targets.size(0)):
        ...
        order_target_list.append(int(level1_targets[i]))
        target_list_sig.append(int(targets[i])+6)
        shape_targets_list.append(int(shape_labels[i])+17)
